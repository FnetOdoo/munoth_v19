...
class ReportHrPayrollCommunityPayslipReport(models.AbstractModel):
    """Alias model so the custom 'payslip_report' template finds its
    report context (get_details_by_rule_category, etc.)"""
    _name = 'report.hr_payroll_community.payslip_report'
    _description = 'Payslip Report (Custom Layout)'
    _inherit = 'report.hr_payroll_community.report_payslipdetails'