...

{
    ...
    "assets": {
        "web._assets_primary_variables": [
            ...
            # Add per-component variables after primary_variables.scss (explicit paths — globs cannot be used as anchors)
            (
                "after",
                "web/static/src/scss/primary_variables.scss",
                "ica_web_responsive/static/src/webclient/navbar/navbar.variables.scss",
            ),
            (
                "after",
                "web/static/src/scss/primary_variables.scss",
                "ica_web_responsive/static/src/webclient/home_menu/home_menu.variables.scss",
            ),
        ],
        ...
        "web.dark_mode_variables": [
            ...
            # Per-component variables (explicit paths — globs cannot be used as anchors)
            (
                "before",
                "ica_web_responsive/static/src/webclient/navbar/navbar.variables.scss",
                "ica_web_responsive/static/src/webclient/navbar/navbar.variables.dark.scss",
            ),
            (
                "before",
                "ica_web_responsive/static/src/webclient/home_menu/home_menu.variables.scss",
                "ica_web_responsive/static/src/webclient/home_menu/home_menu.variables.dark.scss",
            ),
        ],
        "web.assets_web_dark": [
            ("include", "web.dark_mode_variables"),
