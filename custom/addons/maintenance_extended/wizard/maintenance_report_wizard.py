...
class MaintenanceReportWizard(models.TransientModel):
    ...
    def _get_requests(self):
        """All Maintenance Requests created within the selected date
        range, in every stage/state (filtered on create_date only),
        excluding calibration requests."""
        self.ensure_one()
        domain = [
    ...
    def _report_columns(self):
        ...
        columns = [
            ...
            ('Sequence', 16, lambda r: r.sequence or ''),
        ...
        columns += [
            ...
            ('State', 16, lambda r: r.stage_id.display_name or ''),
        ]
        if has('user_ids'):
            columns.append(('Done By', 24,
    ...
    def _breakdown_columns(self):
        ...
        columns = [
            ...
            ('Requested Time', 18,
             lambda r: self._fmt_dt(r.requested_time)),
            ('Attended By', 20,
