...
class AccountMove(models.Model):
    ...
    def _auto_create_asset(self):
        ...
        for move in self:
            ...
            # Migration v15→v19: user_type_id.internal_group removed; use account_type
            for move_line in move.line_ids.filtered(lambda line: not (move.move_type in ('out_invoice', 'out_refund') and line.account_id.account_type in ('asset_fixed', 'asset_non_current', 'asset_current', 'asset_prepayments'))):
                if (
                    ...
                    vals = {
                        ...
                        # Migration v15→v19: analytic_account_id still valid on account.move.line in v17/18
