...
""",
    ...
    'assets': {
        'web.assets_backend': [
            'sales_subscription/static/src/js/tours/sale_subscription.js',
            'sales_subscription/static/src/scss/sale_subscription_backend.scss',
        ],
        'web.assets_frontend': [
            'sales_subscription/static/src/js/portal_subscription.js',
        ],
    }
}
